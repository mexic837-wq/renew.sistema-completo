...
// 1. Create js/screens/plantillaPozo.js
const plantillaPozoCode = `/* ============================================================
...
`;
fs.writeFileSync('js/screens/plantillaPozo.js', plantillaPozoCode);

// 2. Patch index.html
let html = fs.readFileSync('index.html', 'utf8');
if (!html.includes('plantillaPozo.js')) {
    html = html.replace('<script type="module" src="./js/screens/confirmacionInstalacion.js"></script>', '<script type="module" src="./js/screens/confirmacionInstalacion.js"></script>\n  <script type="module" src="./js/screens/plantillaPozo.js"></script>');
}
if (!html.includes('id="screen-plantilla-pozo"')) {
    html = html.replace('<!-- Rendered by confirmacionInstalacion.js -->', '<!-- Rendered by confirmacionInstalacion.js -->\n      <div id="screen-plantilla-pozo" class="screen hide"></div>');
}
fs.writeFileSync('index.html', html);

// 3. Patch app.js
let appjs = fs.readFileSync('js/app.js', 'utf8');
if (!appjs.includes('renderPlantillaPozo')) {
    appjs = appjs.replace("import { renderConfirmacionInstalacion } from './screens/confirmacionInstalacion.js';", "import { renderConfirmacionInstalacion } from './screens/confirmacionInstalacion.js';\nimport { renderPlantillaPozo } from './screens/plantillaPozo.js';");
}
if (!appjs.includes("case 'plantilla-pozo': renderPlantillaPozo(); break;")) {
    appjs = appjs.replace("case 'confirmacion-instalacion': renderConfirmacionInstalacion(); break;", "case 'confirmacion-instalacion': renderConfirmacionInstalacion(); break;\n    case 'plantilla-pozo': renderPlantillaPozo(); break;");
}
fs.writeFileSync('js/app.js', appjs);

// 4. Patch plantillas.js
let plantillas = fs.readFileSync('js/screens/plantillas.js', 'utf8');
if (!plantillas.includes('plantilla-pozo')) {
    const cardHtml = `
          {
            id:     'plantilla_pozo',
    ...
    plantillas = plantillas.replace("title:  'Confirmación de Instalación',", cardHtml + "\n          {\n            title:  'Confirmación de Instalación',");
}
fs.writeFileSync('js/screens/plantillas.js', plantillas);
