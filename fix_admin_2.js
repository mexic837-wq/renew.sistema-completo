...
html = html.replace(/<input type="checkbox" name="chk-cli-dept" value="Water"[^>]*>\s*[^<]*Water/g, 
    '<input type="checkbox" name="chk-cli-dept" value="Water" class="w-4 h-4 rounded border-gray-300 text-tealAccent focus:ring-tealAccent"> 🌊 Water');
...
html = html.replace(/<input type="checkbox" name="det-chk-dept" value="Water"[^>]*>\s*[^<]*Water/g, 
    '<input type="checkbox" name="det-chk-dept" value="Water" class="w-4 h-4 rounded border-gray-300 text-tealAccent focus:ring-tealAccent"> 🌊 Water');
...
html = html.replace(/<option value="En Proceso">[^<]*En Proceso \(Pipeline Activo\)<\/option>/g, '<option value="En Proceso">🛡️ En Proceso (Pipeline Activo)</option>');
html = html.replace(/<option value="En Proceso">[^<]*En Proceso<\/option>/g, '<option value="En Proceso">🛡️ En Proceso</option>');
