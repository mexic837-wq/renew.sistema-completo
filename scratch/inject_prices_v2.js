...
const products = [
  // LINEA RENEW ECONÓMICA
  {
    ...
    precio_oficina: 1600,
    solo_equipo_grande: 1600 // Using Vendedor as baseline
  },
  {
    codigo: "E-302",
...
async function inject() {
    console.log(`Injecting ${products.length} products manually verified from images...`);
    ...
    const records = products.map(p => ({
        ...
        es_activo: true,
        sede: 'todas',
        precio_full: p.precio_vendedor // Setting Vendedor as the standard "Full" price
    }));
    ...
    try {
        ...
        console.log("Success! Data injected correctly.");
