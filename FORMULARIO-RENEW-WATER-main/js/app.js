...
const APP_CONFIG = {
   ...
   */
  webhookUrl: 'https://n8n.milian-app.online/webhook/aplicacion-credito-o-trabajo',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Cuando este portal se abre desde el SPA de Renew OS dentro de un iframe,
  // el URL tendrá ?tab=credit o ?tab=workorder para ir directo al formulario.
  ...
  // Si tab=credit o no hay parámetro, se queda en la pestaña por defecto (crédito)
});
