...
export async function renderMiEquipo() {
  ...
  screen.innerHTML = `
    <div class="dash-header" style="padding-bottom: 16px; position: sticky; top: 0; z-index: 50; background: var(--bg-main);">
      ...
      <!-- Fila 2: Buscador y Filtro de rol -->
      <div style="display:flex; flex-direction:column; md:flex-row; gap:8px; padding:0 20px; margin-top:8px;">
          <div style="display:flex; gap:8px; w-full">
              ...
              <select id="team-role-filter" style="border-radius:14px;border:1.5px solid var(--border);background:var(--surface);color:var(--text-primary);font-size:0.82rem;font-weight:600;padding:0 12px;outline:none; cursor:pointer;">
